# -------------------------------------------------------
# Script: 4 EDA_WordClouds.R
# Purpose: Generate word clouds to visualize frequent words by sentiment.
# Key Info: Highlights common positive, neutral, and negative terms.
# Input: Cleaned or sentiment-labeled dataset
# Output: Word cloud images for EDA
# -------------------------------------------------------
