...
lda_fit <- lda(factor(review.score) ~but_count + pos + neg + compound + Num_Words + Num_Exclamations, data = data1_train) #fitting model
lda_fit
```
...
## Predictions on Testing Data with Model and Looking at Accuracy
...
## Testing Out Another Model with Possibly Insignificant Predictors
...
## Testing Quantitative Goal With Other Model
